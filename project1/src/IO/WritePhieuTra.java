...
public class WritePhieuTra {
	public void WriteWord(JTable tb,JComboBox cbPM,JTextField txtMBD,JTextField txtTenBD,JTextField txtTienPhat,String TenFile,String TenTieuDe){
		...
		String str4=txtTienPhat.getText();
		...
		paragraphOneRunThree.addBreak();
		paragraphOneRunThree.setText("Tổng số tiền phạt:"+str4);
		paragraphOneRunThree.addBreak();
